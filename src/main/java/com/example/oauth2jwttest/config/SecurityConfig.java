...
import com.example.oauth2jwttest.jwt.JWTFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // cors allowed in "http://localhost:3000"
        http
        ...
        //JwtFilter 추가 (UsernamePasswordAuthenticationFilter.class 앞에 추가)
        http
